            ...
            <div class="card-body card-block">
                <form action="{{route('students.update',$student->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="id" name="id" value="{{$student->id}}" placeholder="Code" class="form-control">
                            @error('id')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="name" name="name" value="{{$student->name}}" placeholder="Name" class="form-control">
                           @error('name')
                            <small class="form-text text-muted" style="color: red!important;">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="email" id="email" name="email"  value="{{$student->email}}" placeholder="Email" class="form-control">
                            @error('email')
                            <small class="form-text text-muted" style="color: red!important;">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="phone" name="phone" value="{{$student->phone}}" placeholder="Phone" class="form-control">
                            @error('phone')
                            <small class="form-text text-muted" style="color: red!important;">{{$message}}</small>
                            @enderror
                        </div>
